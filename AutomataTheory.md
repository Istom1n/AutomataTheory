##Содержание
Не завершено | _В работе_ | **Завершено**
...
**Инварианты** —  
**Ловушки** (англ. *traps*) — это множество позиций таких, что выполнены условия $P \subseteq P'$ таких, что выполнены условия $\forall t \in T$ если $\exists p_1 \in \bullet t$, $p_1 \in P'$, то $\exists p_2 \in t \bullet$, $p_2 \in P'$
...
[Книга Workflow Management](http://wwwis.win.tue.nl/~wvdaalst/publications/p120.pdf)
